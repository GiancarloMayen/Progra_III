...
public class Departamentos_empleados {
    ...
    /* Este programa esta diseÃƒÂ±ado para calcular los sueldos de los empleados de una empresa en forma aleatoria,
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        for(int z=0;z<10;z++){
            ...
            float ftSueldos=(float)((Math.random()*15000)+2000);
        ...
        System.out.println("Trabajador\tSueldo B.    + (Bonif.   +    comisiones) - (IGSS         +     ISR   + BT        )   =   total     Depto.");
...
//creamos un ciclo for que recorrera la columna 4 de la matriz en donde estan guardados el numero de departamento para poder sumar los sueldos
        ...
        for(int i=0;i<10;i++){//ciclo for que recorre la matriz
            ...
            btOpc=(byte)matrix[i][7];//aqui igualamos la variable bite al valor que esta en la fila del 1 al 10 y la columna 4
